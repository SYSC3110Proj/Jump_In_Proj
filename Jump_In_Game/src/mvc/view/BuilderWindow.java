...
public class BuilderWindow extends JPanel {
	...
	public Direction getF1Dir() {
		Direction dir=null;
		if(rdbtnNorth.isSelected()) {
			dir=Direction.NORTH;
		}
		
		if(rdbtnSouth.isSelected()) {
			dir=Direction.SOUTH;
		}
		
		if(rdbtnEast.isSelected()) {
			dir=Direction.EAST;
		}		
		if(rdbtnWest.isSelected()) {
			dir=Direction.WEST;
		}
		return dir;
	}
	
	public Direction getF2Dir() {
		Direction dir=null;
		if(rdbtnNorth_1.isSelected()) {
			dir=Direction.NORTH;
		}
		
		if(rdbtnSouth_1.isSelected()) {
			dir=Direction.SOUTH;
		}
		
		if(rdbtnEast_1.isSelected()) {
			dir=Direction.EAST;
		}		
		if(rdbtnWest_1.isSelected()) {
			dir=Direction.WEST;
		}
		return dir;
	}
